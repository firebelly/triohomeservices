...
<!--[if gt IE 9]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  <body>
    <header class="site-header" role="banner">
      <a href="#" class="to-top">
        <div class="replace-with-svg-logo"></div>
      </a>
      <h1 class="visually-hidden">Trio Home Services <img src="assets/images/logo.svg" alt="Trio Home Services logo" class="logo"></h1>
      <button class="open-mobile-nav nav-open-button"><img src="assets/images/hamburger.svg" alt="Close mobile nav" class="icon-hamburger"></button>
    ...
    <main class="site-main" role="main">
      <section class="site-section -headline">
        <div class="section-content user-content">
          <p><span class="single-line-md">Compassionate, professional </span>and personal assistance in the comfort of your own home.</p>
